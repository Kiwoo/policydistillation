...
# import logger
import sys
import trpo_conti_epopt
from mlp_conti_epopt import MlpContinuousEpoptPolicy
from misc_util import set_global_seeds
num_cpu=1
...
def train(env_id, ctrl_range, num_timesteps, seed, save_name):
    ...
    def policy_fn(name, ob_space, ac_space):
        return MlpContinuousEpoptPolicy(name=name, ob_space=env.observation_space, ac_space=env.action_space, control_space = 1,
    ...
    trpo_conti_epopt.learn(env = env, save_name = save_name, ctrl_range = ctrl_range, policy_func = policy_fn, timesteps_per_batch=20000, max_kl=0.01, cg_iters=10, cg_damping=0.1,

...
def learn(env_list, env_id_list, policy_func, 
    ...
    compute_lossandgrad = U.function([ob, c_in, ac, atarg], losses + [U.flatgrad(optimgain, var_list)])
    ...
    # saver = tf.train.Saver(max_to_keep = None)
    cur_dir = get_cur_dir()
    save_dir = os.path.join(cur_dir, "ControlSimple")
    print save_dir
    ...
    while True:        
        ...
        if iters_so_far % save_data_freq == 1:
            ...
            log_dir = "{}_log".format("ControlSimple")
